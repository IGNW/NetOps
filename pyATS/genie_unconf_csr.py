...
# dev_csr_interface.ipv4 = "0.0.0.0"
# dev_csr_interface.ipv4.netmask = "0.0.0.0"
dev_csr_interface.description = None
dev_csr_interface.enabled = False
dev_csr_interface.shutdown = True
